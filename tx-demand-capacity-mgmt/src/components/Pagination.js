...
const Pagination = ({pages, setCurrentPage, currentDemands, demands}) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentDemands.length}</b> out of <b>{demands.length}</b> entries</div>
